# Taken with minimal modifications from https://github.com/bentoml/BentoML/blob/ad915a76f556661b73538c1d4fec92f3b92266e3/bentoml/_internal/marshal/dispatcher.py
import time
import typing as t
import asyncio
import logging
...
class Optimizer:
    ...
    def log_outbound(self, n, wait, duration):
        logger.debug(f"Outbound: n: {n}, wait: {wait}, duration: {duration}")
        if (
